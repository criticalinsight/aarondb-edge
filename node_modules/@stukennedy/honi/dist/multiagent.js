 ...
 */
export async function routeToAgent(env, agent, message) {
 ...
 */
export async function getAgentHistory(env, agent) {
    const ns = env[agent.binding];
    if (!ns) {
        throw new Error(`Agent binding not found: ${agent.binding}`);
    }
 ...
 */
export async function clearAgentHistory(env, agent) {
    const ns = env[agent.binding];
    if (!ns) {
        throw new Error(`Agent binding not found: ${agent.binding}`);
    }
 ...
 */
export async function callAgentTool(env, agent, toolName, args) {
    const ns = env[agent.binding];
    if (!ns) {
        throw new Error(`Agent binding not found: ${agent.binding}`);
    }
 ...
 */
export async function listAgentTools(env, agent) {
    const ns = env[agent.binding];
    if (!ns) {
        throw new Error(`Agent binding not found: ${agent.binding}`);
    }
